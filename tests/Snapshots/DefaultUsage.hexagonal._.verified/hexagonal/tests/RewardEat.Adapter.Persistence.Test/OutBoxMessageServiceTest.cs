...
public class OutBoxMessageServiceTest : IClassFixture<RewardEatDbContextFixture>
{
    private readonly Mock<IDateTimeProvider> _dateTimeProviderMock;
    private readonly RewardEatDbContext _dbContext;
    private readonly Mock<IGuidProvider> _guidProviderMock;
    private readonly IOutBoxMessageService _sut;
    private readonly CancellationToken _cancellationToken = new CancellationTokenSource().Token;

    public OutBoxMessageServiceTest(RewardEatDbContextFixture fixture)
    {
